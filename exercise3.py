...
class Rectangle:
    ...
    def contains(self, point: Point2D, tolerance: float = 0.0) -> bool: # Task B
        ...
        return self.is_in_interval(ll_px, 0.0 - tolerance, self._dx + tolerance) \
            and self.is_in_interval(ll_py, 0.0 - tolerance, self._dy + tolerance)
    ...
    def is_in_interval(self, i: float, start: float, end: float) -> bool: # Task A
